...
app.post('/iron/auth', function(req,res){
...
app.get('/iron/checkauth', function(req,res){
...
app.post('/iron/adduser', function(req,res){
    if(!verifyAccessTokenFromReq(req)){
        res.sendStatus(401);
        return
    }
...
///////////////
// 
app.patch('/iron/updateuser', function(req,res){
    if(!verifyAccessTokenFromReq(req)){
        res.sendStatus(401);
        return
    }
...
///////////////////////
//
app.delete('/iron/deleteuser', function(req,res){
    if(!verifyAccessTokenFromReq(req)){
        res.sendStatus(401);
        return
    }
...
///////////////////
// 
app.get('/iron/getallusers', function(req,res){
    if(!verifyAccessTokenFromReq(req)){
        res.sendStatus(401);
        return
    }
...
////////////////////
// 
app.get('/iron/getuserbyid', function(req,res){
    if(!verifyAccessTokenFromReq(req)){
        res.sendStatus(401);
        return
    }
...
/////////////////////
// 
app.post('/iron/addconcentrate', async function(req,res){
    if(!verifyAccessTokenFromReq(req)){
        res.sendStatus(401);
        return
    }
...
////////////////////////
// 
app.post('/iron/updateconcentrates', async function(req,res){
    if(!verifyAccessTokenFromReq(req)){
        res.sendStatus(401);
        return
    }
...
////////////////////////
// 
app.delete('/iron/deleteconcentrate', function(req,res){
    if(!verifyAccessTokenFromReq(req)){
        res.sendStatus(401);
        return
    }
...
//////////////////////////
// 
app.get('/iron/getallconcentrates', function(req,res){
    if(!verifyAccessTokenFromReq(req)){
        res.sendStatus(401);
        return
    }
